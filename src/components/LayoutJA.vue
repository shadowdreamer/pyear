      ...
      <p>
        ...
        <p>
          ...
          <ul>
            ...
            <span style="display:inline-block;width:120px">アイドル</span>
            <span style="display:inline-block;width:50px">ファンの数</span>
            <li
        ...
        <P>
          ...
          フラスタsent ：<el-input-number
            v-model="input.flowerSend"
            style="width:100px"
            :controls="false"
          ></el-input-number><br>
          フラスタreceived：<el-input-number
        ...
        <p>
          ...
          18年ライブクリアした回数：<el-input-number
            v-model="input.songCount"
            style="width:100px"
            :controls="false"
          ></el-input-number><br>
          フルコンボした回数：<el-input-number
        ...
        <p>
          ...
          millonmixをフルコンボした曲の数：<el-input-number
        ...
        <p>
          ...
          大体何回ガチャした：<el-input-number
            v-model="input.gashaCount"
            style="width:100px"
            :controls="false"
          ></el-input-number><br>
          ssrの数：<el-input-number
        ...
        <p>
          ...
          メタルガチャは大体何回：<el-input-number
            v-model="input.pinkGasha"
            style="width:100px"
            :controls="false"
          ></el-input-number><br>
          メタルガチャのssr数：<el-input-number
        ...
        <p>
          ...
          周年記念カード何枚を覚醒した：<el-input-number
            v-model="input.aniva"
            style="width:100px"
            :controls="false"
          ></el-input-number>
